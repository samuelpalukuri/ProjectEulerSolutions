 ...
 *
 */
public class P008 implements EulerSolution {
	...
	@Override
	public String run() {
		String inputString = "73167176531330624919225119674426574742355349194934"
		...
		for (int i = 0; i < 1000 - 12; i++) {
			...
			String locSubStr = inputString.substring(i, i + 13);
			long locSubLong = Long.parseLong(locSubStr);
			long localProduct = Library.productOfDigits(locSubLong);
